...
rusland = input("Heeft u in Rusland gereden? ").lower()
...
if (rijbewijs == "ja" or rusland == "ja") and hoed == "ja" and (gewicht > GEWICHT_MIN and gewicht < GEWICHT_MAX) and (ervaringDieren > ERVARING_DIEREN_MIN or ervaringJongleren > ERVARING_JONGLEREN_MIN or ervaringAcrobatiek > ERVARING_ACROBATIEK_MIN):
